...
NSString *const MJRefreshHeaderStateRefreshFailText = @"刷新失败";
NSString *const MJRefreshHeaderStateRefreshSuccessText = @"刷新成功";


NSString *const MJRefreshFooterStateIdleText = @"点击加载更多";
NSString *const MJRefreshFooterStateRefreshingText = @"正在加载更多的数据...";
NSString *const MJRefreshFooterStateNoMoreDataText = @"刷新成功";